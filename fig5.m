...
% plot figure 5b
subplot(432)
h = errorbar(fig5b.electronEnergy, fig5b.derivedSource, fig5b.minimum, fig5b.maximum, 'bo-'); hold on;
...
% plot figure 5e
subplot(435)
h = errorbar(fig5e.electronEnergy, fig5e.derivedSource, fig5e.minimum, fig5e.maximum, 'ro-'); hold on;
plot(fig5e.En, fig5e.mcSource, 'k', 'lineWidth', 1);
...
% plot figure 5h
subplot(438)
h = errorbar(fig5h.electronEnergy, fig5h.derivedSource, fig5h.minimum, fig5h.maximum, 'co-'); hold on;
plot(fig5h.En, fig5h.mcSource, 'k', 'lineWidth', 1);
...
% plot figure 5k
subplot(4,3,11)
h = errorbar(fig5k.electronEnergy, fig5k.derivedSource, fig5k.minimum, fig5k.maximum, 'o-', 'Color',[0.75, 0, 0.75]); hold on;
plot(fig5k.En, fig5k.mcSource, 'k', 'lineWidth', 1);
